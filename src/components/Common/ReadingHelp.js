    ...
    if (id === 1) {
      ...
      setPopupContent(
        <div className="canvas-procedure-box ">
          <div className="canvas-procedure-text d-flex justify-content-center align-items-center">
            <p>
              Use the <b>‘Comment’</b> option to add a typed comment about the
              selected text.
            </p>
          </div>
          <div className="canvas-procedure-image mt-lg-4 pt-lg-4">
            <img ref={gifRef} src="./img/ReadingInfo/Comments.gif" />
          </div>
        </div>
      );
    } else if (id === 8) {
        ...
        <Modal.Body>
          ...
          <p className="border p-3 reading-popup-box mx-auto position-relative">
            ...
            <p className="mb-10 line-height-22">
              <strong>Let’s revisit what John Dalton</strong> and his colleagues
              were investigating in the 1800s.{" "}
              <em>Last we read, they carried out</em> two different types of{" "}
              <u>investigations with water</u>, both involving adding energy to
              it.{" "}
              <span style={{ color: "rgb(254, 105, 42)" }}>
                When they boiled water
              </span>
              , they argued that this did not
              <span style={{ backgroundColor: "rgb(210, 112, 255)" }}>
                {" "}
                produce a new substance
              </span>
              .
              <span className="ql-custom-circle-sketch-highlight">
                But when they added energy
              </span>
              to water with a battery, they argued that this produced two new
              substances that weren’t there before.
            </p>
            {/* <p className="mb-10 line-height-22">
              They conducted flammability tests and also measured the density of
              these gases. The one that exploded had a density of 0.09 g/L. This
              was much less dense than other flammable gases, like marsh gas
              (methane). The one that caused a match to burn brighter also
              caused a glowing ember to burst into flame. It had a density of
              1.430 g/L.
            </p> */}
            <p
            ...
            >
              Dalton developed a new idea to explain these results. He argued
              that water particles could be broken apart into the parts that
              make up each of the two gases. In his model, he assumed that each
              water particle was actually made of two smaller parts connected
              together. He called these smaller parts “atoms.”
            </p>
                    ...
                    <span className="ql-formats">
                      <button type="button" class="ql-bold position-relative">
                        ...
                        <div className="popuptext-box postion_1_reading">
                          <div onClick={() => handleStepChange(1, 2, 20000)}>
                            <a>Bold</a>
                          </div>
                          <div className="popup-border-90 pe-none"></div>
                        </div>
                      </button>
                      ...
                      >
                        ...
                        <div className="popuptext-box postion_3_reading  coloum-gap-0">
                          <div
                            className="text-title-popup mt-35 cursor-pointer"
                            onClick={() => handleStepChange(3, 2, 20000)}
                          >
                            <a>Underline</a>
                          </div>
                      ...
                      <span className="position-relative">
                        <button
                          onClick={() => handleStepChange(7, 1.1, 27000)}
                          type="button"
                          class="ql-comment cursor-pointer"
                        >
                          {" "}
                        </button>
                        <div className="popuptext-box postion_7_reading">
