    ...
    if (id === 1) {
      ...
      setPopupContent(
        <div className="canvas-procedure-box ">
          <div className="canvas-procedure-text d-flex justify-content-center align-items-center">
            <p>
              Use the <b>‘Check Mark’</b> option to reformat the selected text
              by highlighting it green and adding a check mark at the end of the
              selection.
            </p>
          </div>
          <div className="canvas-procedure-image1  ">
            <img ref={gifRef} src="./img/ReadingInfo/Checkmark.gif" />
          </div>
        </div>
      );
    } else if (id === 8) {
      ...
      setPopupContent(
        <div className="canvas-procedure-box ">
          <div className="canvas-procedure-text d-flex justify-content-center align-items-center">
            <p>
              Use the <b>‘Star’</b> option to reformat the selected text by
              highlighting it yellow and adding a star at the end of the
              selection.
            </p>
          </div>
          <div className="canvas-procedure-image1  mt-lg-4 pt-lg-4">
            <img ref={gifRef} src="./img/ReadingInfo/Star.gif" />
          </div>
        </div>
      );
    }
        ...
        <Modal.Body>
          ...
          <p className="border p-3 reading-popup-box mx-auto position-relative">
            ...
            <p className="mb-10 line-height-22">
              <strong>
                Think about people you have seen use headphones to listen to
                music on a phone or to complete an assignment on a computer in
                school
              </strong>
              .<em>We have learned a lot about how speakers work.</em>
            </p>
            <p>
              <strong>
                What do you think headphones have in common with the speakers
                you investigated in science class so far?{" "}
              </strong>
            </p>
            <p>
              <u>You may have noticed in the photos</u> above that headphones
              contain many of the same parts as a speaker (including a magnet
              and a coil of wire).{" "}
              <span style={{ color: "rgb(254, 105, 42)" }}>
                Those parts are small compared
              </span>{" "}
              to the parts of the speakers you made in class.
            </p>
            <p>
              We learned that{" "}
              ...
              forces between the magnet and the coil lead to vibrations in the
              speaker. These{" "}
              <span className="text-highlight-star">
                vibrations produce the sound
              </span>{" "}
              we hear. The{" "}
              <span className="text-highlight-tick">
                attractive and repulsive forces
              </span>{" "}
              inside a speaker happen when an electric current flows through the
              coil. The current causes the coil to behave like a magnet.
            </p>
            <p style={{ paddingBottom: "140px" }}>
              Like all speakers, headphones must be connected to a source of
              electric current in order to work.{" "}
            </p>
                  ...
                  <div className="ql-toolbar popup-featues">
                    <span className="ql-formats">
                      ...
                      <button className="position-relative">
                        ...
                        <div className="popuptext-box postion_5_reading_star coloum-gap-0">
                          <div className="popup-border-ttob height-90"></div>
                          <div className="popup-border-300 height-90"></div>
                      ...
                      <button type="button" class="ql-clean position-relative">
                        ...
                        <div className="popuptext-box postion_8_reading1 coloum-gap-0">
                          <div className="popup-border-ttob height-50"></div>
                          <div className="popup-border-240 height-50"></div>
                      ...
                      <span className=" position-relative">
                        ...
                        <div className="popuptext-box postion_6_reading_star coloum-gap-0">
                          <div className="popup-border-ttob"></div>
                          <div className="popup-border-170 height-20"></div>
                          <div
                            style={{ color: "#000" }}
                      ...
                      <span className="position-relative">
                        <button
                          onClick={() => handleStepChange(9, 1.1, 19000)}
                          type="button"
                          class="ql-star cursor-pointer"
                        >
                          <img
                            src="./img/star.svg"
                            width="`20px`"
                        ...
                        <div className="popuptext-box postion_6_reading1 coloum-gap-0">
                          <div className="popup-border-ttob"></div>
                          <div className="popup-border-150 height-25"></div>
                          <div
                            style={{ color: "#000" }}
                            className="margin-top-minus pl-5 cursor-pointer"
                            onClick={() => handleStepChange(9, 1.1, 19000)}
                          >
                            <a>Star</a>
                          </div>
                      ...
                      <span className="position-relative">
                        <button
                          onClick={() => handleStepChange(7, 1.1, 17000)}
                          type="button"
                          class="ql-tick cursor-pointer"
                        >
                          <img
                            src="./img/tick-highlight.svg"
                            width="`20px`"
                            height="`20px`/"
                          />
                        </button>
                        <div className="popuptext-box postion_7_reading1">
                          <div className="popup-border-40"></div>
                          <div
                            style={{ color: "#000" }}
