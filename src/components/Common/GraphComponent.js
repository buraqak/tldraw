...
import GraphcanvasHelp from "./GraphcanvasHelp";
...
const GraphComponent = (props) => {
  ...
  function saveCanvas() {
    ...
    downloadLink.setAttribute("download", "OSE_GraphCanvas" + ".png");
        ...
        <div className="d-grid align-items-center drawing-body">
          ...
          <div className="d-grid-column drawing-navi right">
            <ul className="d-grid justify-content-center align-items-center ">
              ...
              <li className="drawing pb-3 pb-lg-3  pe-lg-0" id="drawPencil">
