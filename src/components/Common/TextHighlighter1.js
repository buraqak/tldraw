...
icons["star"] = "<img src=./img/star.svg width=`20px` height=`20px`/>";
icons["tick"] =
  "<img src=./img/tick-highlight.svg width=`20px` height=`20px`/>";
...
class StarBlot extends Inline {
  static blotName = "star";
  static tagName = "SPAN";
  static className = "text-highlight-star";
  static formats() {
    return true;
  }
}

class TickBlot extends Inline {
  static blotName = "tick";
  static tagName = "SPAN";
  static className = "text-highlight-tick";
  static formats() {
    return true;
  }
}

Quill.register("formats/star", StarBlot);
Quill.register("formats/tick", TickBlot);
export const TextHighlighter1 = React.memo(
...
export default TextHighlighter1;
