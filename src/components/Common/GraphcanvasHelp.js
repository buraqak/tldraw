    ...
    if (id === 1) {
      ...
      setPopupContent(
        <div className="canvas-procedure-box ">
          <div
            style={{ fontSize: "20px" }}
            className="canvas-procedure-text d-flex justify-content-center align-items-center "
          >
            <p>
              To create a graph using the canvas, you will use many different
              options.
              <ul className="pt-10">
                <li className="pb-5 text-start">
                  Use the <b>‘Line’</b> option to draw the X and Y axes of the
                  graph.
                </li>{" "}
                <li className="pb-5 text-start">
                  {" "}
                  Use the <b>‘Add Text’</b> option to label the axes. Rotate the
                  text for the y-axis.
                </li>{" "}
                <li className="pb-5 text-start">
                  {" "}
                  Use the <b>‘Pen’</b> option to mark the data points on the
                  graph. Then use the <b>‘Color Selection’</b> to change the
                  data points’ color as needed.
                </li>
                <li className="text-start">
                  {" "}
                  Use the <b>‘Line’</b> option to create a line of best fit.
                </li>
              </ul>
            </p>
          </div>
          <div className="canvas-procedure-image1  ">
            <img ref={gifRef} src="./img/CanvasInfo/graph_full.gif" />
          </div>
        </div>
      );
    }
          ...
          <div className="canvas-mainpopup-box justify-content-center">
            <div className="canvas-procedure-image ">
              <div class="drawing-section pb-0">
                ...
                <div class="d-grid align-items-center drawing-body-graph">
                  <div class="d-grid-column drawing-navi left">
                    <ul class="d-grid justify-content-center align-items-center">
                      ...
                      <li
                        onClick={() => handleStepChange(4, 2, 16000)}
                        type="button"
                        class="button"
                        id="insertText"
                        aria-label="Add line"
                  ...
                  <div
                    onClick={() => handleStepChange(11, 5.6, 57000)}
                    id="graph-popup"
                    class="d-grid-column drawing-canvas-circle d-flex justify-content-center cursor-pointer"
                  >
                    <img src="./img/CanvasInfo/graph-image.png" />
                  </div>
              ...
              <div className="popuptext-box postion_1_graph">
                <div
              ...
              <div className="popuptext-box postion_2_graph">
                <div
                  className="cursor-pointer"
                  onClick={() => handleStepChange(2, 1.5, 8500)}
                >
              ...
              <div className="popuptext-box postion_3_graph">
                <div
                  className="cursor-pointer"
                  onClick={() => handleStepChange(3, 2, 12000)}
                >
              ...
              <div className="popuptext-box postion_4_graph">
                <div
                  className="cursor-pointer"
                  onClick={() => handleStepChange(4, 2, 16000)}
                >
              ...
              <div className="popuptext-box postion_5_graph">
                <div
                  className="cursor-pointer"
                  onClick={() => handleStepChange(5, 1.8, 11000)}
                >
              ...
              <div className="popuptext-box postion_6_graph">
                <div
                  className="cursor-pointer"
                  onClick={() => handleStepChange(6, 1.1, 6500)}
                >
              ...
              <div className="popuptext-box postion_11_graph">
                <div className="popup-border-right"></div>
                <div
                  className="cursor-pointer"
                  onClick={() => handleStepChange(11, 5.6, 57000)}
