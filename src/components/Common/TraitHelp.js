      ...
      >
        ...
        <Modal.Body className="pb-0">
          ...
          >
            <div
              id="accord1"
              class="accordion-item image-matches-accordion-list mb-20"
            >
              <h2 class="accordion-header" id="accord1">
                <button class="accordion-button cursor-context" type="button">
                        ...
                        >
                          <div>
                            <div className="position-relative">
                              ...
                              <div className="popuptext-box postion_1_traits">
                                <div
                                  className="cursor-pointer"
                                  onClick={() =>
                                    handleStepChange(1, 1.8, 10000)
                                  }
                                >
                                  <a>Sort Title</a>
                                </div>
                            ...
                            <div class="popup position-relative">
                              <div
                                class="float-end images-list-popup-icon"
                              ...
                              >
                                ...
                                >
                                  <div className="position-relative">
                                    <img
                                      src="./img/image-popup-icon.svg"
                                      className="cursor-pointer"
                                      onClick={() =>
                                        handleStepChange(7, 2.4, 19000)
                                      }
                                    />
                                    <div className="popuptext-box postion_8_traits">
                                      <div className="popup-border pe-none"></div>
                                      <div
                                        onClick={() =>
                                          handleStepChange(7, 2.4, 19000)
                                        }
                            ...
                            modal-lg"
                              ...
                              <div className="popuptext-box postion_3_traits">
                                <div
                                  className="cursor-pointer"
                                  onClick={() =>
                                    handleStepChange(2, 2.6, 14000)
                                  }
                                >
                                  <a>Sortable Images</a>
                                </div>
                                ...
                                <div class="col-12 col-lg-6">
                                  <div class="card h-100">
                                    <div className="position-relative">
                                      ...
                                      <div className="popuptext-box postion_5_traits">
                                        <div className="popup-border"></div>
                                        <div
                                          className="cursor-pointer"
                                          onClick={() =>
                                    ...
                                    <div class="card-body">
                                      <div className="position-relative">
                                        <div
                                          ...
                                          class="trait-input variation-input cursor-pointer "
                                        >
                                          <input
                                            type="text"
                                            class="form-control cursor-pointer"
                                        ...
                                        <div className="popuptext-box postion_4_traits">
                                          <div
                                            className="cursor-pointer"
                                            onClick={() =>
                                              handleStepChange(3, 3.8, 23000)
                                          ...
                                          <div class="variation-selection-none variation-selection">
                                            ...
                                            >
                                              <div class="variation-selected-list">
                                                ...
                                                <div class="variation-remove cursor-context">
                                                  <div className="position-relative">
                                                    <img
                                                      className="cursor-pointer"
                                                      onClick={() =>
                                                      ...
                                                      src="./img/variation-selected-remove.svg"
                                                    />
                                                    <div className="popuptext-box postion_6_traits cursor-context">
                                                      <div className="popup-border-100 cursor-context"></div>
                                                      <div
                                                        className="cursor-pointer"
                                                        onClick={() =>
                                                          handleStepChange(
                                    ...
                                    >
                                      <div className="position-relative">
                                        <img
                                          src="./img/variation-add.svg"
                                          className="cursor-pointer"
                                        />
                                        <div className="popuptext-box postion_7_traits cursor-context">
                                          <div className="popup-border cursor-context"></div>
                                          <div
                                            className="cursor-pointer"
                                            onClick={() =>
                                              handleStepChange(6, 1.4, 8000)
