    ...
    if (id === 1) {
      ...
      setPopupContent(
        <div className="canvas-procedure-box ">
          ...
          <div className="canvas-procedure-image ">
            <img ref={gifRef} src="./img/CanvasInfo/color-selection.gif" />
          </div>
        </div>
      );
    } else if (id === 8) {
          ...
          <div className="canvas-mainpopup-box  justify-content-center">
            <div className="canvas-procedure-image ">
              <div class="drawing-section pb-0">
                ...
                <div class="d-grid align-items-center drawing-body_popup">
                  <div class="d-grid-column drawing-navi_popup left">
                  ...
                  <div class="d-grid-column drawing-canvas_popup"></div>
                  <div class="d-grid-column drawing-navi_popup right">
                    <ul class="d-grid justify-content-center align-items-center">
                      <li
              ...
              <div className="popuptext-box postion_1">
                <div
              ...
              <div className="popuptext-box postion_2">
                <div
                  className="cursor-pointer"
                  onClick={() => handleStepChange(2, 1.5, 8500)}
                >
              ...
              <div className="popuptext-box postion_3">
                <div
                  className="cursor-pointer"
                  onClick={() => handleStepChange(3, 2, 12000)}
                >
              ...
              <div className="popuptext-box postion_4">
                <div
                  className="cursor-pointer"
                  onClick={() => handleStepChange(5, 2, 12000)}
                >
                  <a>Undo</a>
                </div>
                <div className="popup-border"></div>
              </div>
              <div className="popuptext-box postion_5">
                <div
                  className="cursor-pointer"
                  onClick={() => handleStepChange(6, 1.8, 11000)}
                >
                  <a>Delete</a>
                </div>
                <div className="popup-border"></div>
              </div>
              <div className="popuptext-box postion_6">
                <div
                  className="cursor-pointer"
                  onClick={() => handleStepChange(4, 1.1, 6500)}
                >
                  <a>Eraser</a>
                </div>
                <div className="popup-border"></div>
