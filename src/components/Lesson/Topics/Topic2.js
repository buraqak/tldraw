...
import GraphComponent1 from "../../Common/GraphComponent1.js";
...
const Topic2 = forwardRef((props, ref) => {
                ...
                <div className="row">
                  <div className="drawing-section ">
                    <GraphComponent1
                      ...
                      pageid={props.pageid}
                      canvasImageFileId={props.canvasstr_2_1}
                      canvasDefaultFileId={props.canvasstr_2_1_ori}
                      ...
                      seq_nbr={1}
                      img_seq_nbr={2}
                      canvas_img_uploaded={props.canvas_2_1_img_uploaded}
