...
const Topic1 = forwardRef((props, ref) => {
                ...
                <div className="row">
                  <div className="drawing-section ">
                    <CanvasDraw
                      ...
                      pageid={props.pageid}
                      canvasImageFileId={props.canvasstr_1_1}
                      canvasDefaultFileId={props.canvasstr_1_1_ori}
                      ...
                      seq_nbr={1}
                      img_seq_nbr={1}
                      canvas_img_uploaded={props.canvas_1_1_img_uploaded}
