...
import CanvasDraw from "../../Common/CanvasShapeComponent";
...
const Topic3 = forwardRef((props, ref) => {
              ...
              <div className="">
                <div className="row">
                  <div className="drawing-section ">
                    <CanvasDraw
                      uploadCanvasDataToScorm={props.uploadCanvasDataToScorm}
                      nextTopicIndex={props.nextTopicIndex}
                      pageid={props.pageid}
                      canvasImageFileId={props.canvasstr_3_1}
                      ...
                      canvasDefaultFileId={props.canvasstr_3_1_ori}
                      seq_nbr={1}
                      img_seq_nbr={3}
                      canvas_img_uploaded={props.canvas_3_1_img_uploaded}
                    />
                  </div>
                </div>
              </div>
